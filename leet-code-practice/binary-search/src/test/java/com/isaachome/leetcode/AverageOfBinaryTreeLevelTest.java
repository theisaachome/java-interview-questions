...
class AverageOfBinaryTreeLevelTest {
    private final AverageOfBinaryTreeLevel averageOfBinaryTreeLevel = new AverageOfBinaryTreeLevel();

    @Test
    void testAverageOfLevels1st(){
        ...
        assertEquals(result, averageOfBinaryTreeLevel.averageOfLevels(root));
